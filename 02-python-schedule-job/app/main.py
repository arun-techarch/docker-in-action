...
def main():
    ...
    # Schedule jobs
    schedule.every().day.at("16:55").do(copy_table_data)      # Copy table daily at 1 AM
    schedule.every().day.at("16:55").do(upload_excel_to_db) # Upload Excel every Monday 7 AM
